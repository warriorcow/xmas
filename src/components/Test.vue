  ...
  <div class="test">
    ...
    <transition name="fade" mode="out-in">
      <div v-if="STEP_STATE === 0" :key="0" class="test__start">
        <p>Нажмите на игрушку чтобы начать</p>
      </div>
      <Card v-if="STEP_STATE === 1" :key="1">
        <p>
          В конце 2020 года на связь с RosExpert вышли те самые инопланетяне,
          которые живо наблюдали за событиями, разворачивавшимися на Земле в
          течение года. Да-да, те самые, которые высоко оценили именно этот
          сезон из всех, прошедших к настоящему времени. Из-за разницы в
          межгалактическом времени, они прекрасно осведомлены о том, каким будет
          2021 год. Более того, по вашему рассказу о прошедшем годе, они могут
          безошибочно определить главную вашу траекторию в следующем году, а
          главное – увидеть тот самый ваш талант, который станет вашим
          двигателем и опорой в 2021. Расскажите, как прошел 2020? Мы
          подготовили несколько вопросов, которые помогут вам вспомнить самое
          главное:
        </p>
